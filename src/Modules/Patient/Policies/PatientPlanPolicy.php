...
class PatientPlanPolicy extends BasePolicy
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->entity_singular_name = Str::snake('PatientPlan');

        $this->entity = PatientPlan::whereId( request()->route()->{$this->entity_singular_name} )->first([
            'id',
        ]);
    }
