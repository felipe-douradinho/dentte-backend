...
class PatientAddressPolicy extends BasePolicy
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->entity_singular_name = Str::snake('PatientAddress');

        $this->entity = PatientAddress::whereId( request()->route()->{$this->entity_singular_name} )->first([
            'id',
        ]);
    }
