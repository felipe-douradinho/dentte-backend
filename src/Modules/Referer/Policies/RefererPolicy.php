...
namespace Modules\Referer\Policies;
...
class RefererPolicy extends BasePolicy
{
    use PolicyTrait;
    ...
    public function __construct()
    {
        ...
        $this->entity_singular_name = Str::snake('Referer');

        $this->entity = Referer::whereId( request()->route()->{$this->entity_singular_name} )->first([
            'id',
        ]);
    }
