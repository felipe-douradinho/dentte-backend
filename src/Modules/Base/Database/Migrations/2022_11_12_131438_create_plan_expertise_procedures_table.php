...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create((new Modules\Base\Entities\PlanExpertiseProcedure())->getTable(), function (Blueprint $table) {
            $table->id();
            ...
            $table->enum( 'accept_harmonization', \Modules\Core\Enums\YesNoEnum::toValues() )
                ->default( \Modules\Core\Enums\YesNoEnum::NO->value );
    ...
    {
        Schema::dropIfExists((new Modules\Base\Entities\PlanExpertiseProcedure())->getTable());
    }
};
